...
/**
 * 验证码生成类
 * Created by bu on 2017/9/30.
 */
public class RandomValidateCode {
    public static final String RANDOMCODEKEY= "RANDOMVALIDATECODEKEY";//放到session中的key
    //private String randString = "0123456789";//随机产生只有数字的字符串 private String
    private String randString = "ABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890";//随机产生只有字母的字符串
    //private String randString = "0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ";//随机产生数字与字母组合的字符串
    private int width = 145;// 图片宽
    private int height = 40;// 图片高
    private int lineSize = 40;// 干扰线数量
    private int stringNum = 4;// 随机产生字符数量

    private Random random = new Random();//随机数函数
    ...
    private String drowString(Graphics g, String randomString, int i) {
        ...
        g.drawString(rand, 25* i + random.nextInt(5), height - random.nextInt(8));
        return randomString;
    }
